// Based on https://raw.githubusercontent.com/mikebryant/ac-nh-turnip-prices/master/js/predictions.js
const PATTERN = {
  FLUCTUATING: 0,
  LARGE_SPIKE: 1,
  DECREASING: 2,
...
function pattern_description_to_number(pattern_description) {
  switch(pattern_description) {
    case 'fluctuating':
...
function analyze_possibilities(sell_prices, first_buy, previous_pattern) {
  previous_pattern_id = pattern_description_to_number(previous_pattern)
  generated_possibilities = Array.from(generate_possibilities(sell_prices, first_buy));
  generated_possibilities = get_probabilities(generated_possibilities, previous_pattern_id);
...
exports.get_probabilities = get_probabilities
